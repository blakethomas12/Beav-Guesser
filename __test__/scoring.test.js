...
describe('calculate_score', () => {
    test('returns correct score for given coordinates', () => {
        ...
        const testCases = [
            ...
            { true_x: 100, true_y: 100, user_x: 200, user_y: 200, expected: 3486 },
            { true_x: 400, true_y: 400, user_x: 600, user_y: 600, expected: 2115 },
            { true_x: 500, true_y: 500, user_x: 500, user_y: 500, expected: 5000 },
            { true_x: 500, true_y: 500, user_x: 490, user_y: 490, expected: 5000 }
        ];
